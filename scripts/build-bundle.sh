...
build_one() {
  ...
  run_with_retries mkdir -p "$bin_dir" "$bundle/bin" "$bundle/web/dist" || return 1
  ...
  # 前端构建产物复制
  run_with_retries cp -r web/dist/. "$bundle/web/dist/" || { echo "    WARN: web/dist missing"; return 1; }
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  bin/${exe_name}           Go 编译后的二进制（自带 HTTP 服务，无需 nginx）
  web/dist/                 前端管理页面（内置到二进制静态目录）
  config.yaml       配置文件模板
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  web:
    ...
    static_dir: "/opt/jetlinks-edge/web/dist"   # 前端目录（install.sh 自动设）
